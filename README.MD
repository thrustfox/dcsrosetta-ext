...
BUILDING INFO: You should build with Python 3.7 and luaparser 3.2.1 because bleeding edge versions of them have the problem of not parsing the line break properly.
